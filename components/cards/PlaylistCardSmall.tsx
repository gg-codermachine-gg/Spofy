...
const PlaylistCardSmall: React.FC<CardType> = ({ imageUrl, title }) => {
  return (
    <div className="w-[22.625rem] h-[6.25rem] bg-zinc-800 rounded flex items-center hover:bg-stone-600 transition-color duration-400 ease-out">
      {imageUrl ? (
        ...
        <div className="w-[6.25rem] h-[6.25rem] flex items-center justify-center bg-gradient-to-br from-violet-700 via-indigo-600 to-green-200">
          <Image src="/heart.svg" width={29} height={29} alt="heart" />
        </div>
      )}
